                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control tw-rounded-lg" name="kode_kategori"
                                    id="kode_kategori" wire:model='kode_kategori'>
                                @error('kode_kategori') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                                <label for="nama_kategori">Nama Kategori</label>
                                <input type="text" class="form-control tw-rounded-lg" name="nama_kategori"
                                    id="nama_kategori" wire:model='nama_kategori'>
