                ...
                <div class="card tw-rounded-md tw-shadow-md">
                    <div class="card-body">
                        ...
                        <div class="tw-grid tw-grid-cols-2 tw-gap tw-gap-3">
                            <div>
                                <a href="{{ route('laporan-excel.saldo-awal', ["id_user" => Auth::id(), "id_barang"=> $this->filter_id_barang,
                            ...
                            <div>
                                <a href="{{ route('laporan-pdf.saldo-awal', ["id_user" => Auth::id(), "id_barang"=> $this->filter_id_barang,
                                    "dari_tanggal" => $this->filter_dari_tanggal, "sampai_tanggal" =>
