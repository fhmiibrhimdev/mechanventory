<div>
    <div class="section-header tw-rounded-lg tw-text-black tw-shadow-md tw-shadow-gray-200">
        <h4 class="tw-text-lg">Laporan Barang Keluar</h4>
    </div>
                ...
                <div class="activities">
                    ...
                    <div class="activity">
                        ...
                        <div class="activity-detail">
                            ...
                            <p>Menambahkan barang: <b class="tw-text-gray-900">{{ $row->nama_item }}</b> sebanyak <b class="tw-text-gray-900">{{ $row->qty }}</b> pcs</p><br/>
